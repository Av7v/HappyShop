...
public record UIStyle() {
    ...
    public static final int customerWinHeight = 350;
    ...
    public static final int pickerWinHeight = 350;

    public static final int trackerWinWidth = 210;
    public static final int trackerWinHeight = 350;

    public static final int warehouseWinWidth = 630;
    public static final int warehouseWinHeight = 350;
    ...
    public static final int EmergencyExitWinHeight = 350;

    public static final String labelTitleStyle = "-fx-font-weight: bold; " +
            "-fx-font-size: 16px; -fx-text-fill: salmon;";
    ...
    public static final String rootStyleColorful = "-fx-padding: 8px; " +
            "-fx-background-color: lightgreen";

    public static final String rootStyleDark = "-fx-padding: 8px; " +
            "-fx-background-color: LightSlateGrey";

    public static final String rootStyleLight = "-fx-padding: 8px; " +
    ...
    public static final String rootStyleWarehouseColorful = "-fx-padding: 8px; " +
            "-fx-background-color: darkcyan";
    public static final String rootStyleWarehouseDark = "-fx-padding: 8px; " +
            "-fx-background-color: black";
    public static final String rootStyleWarehouseLight = "-fx-padding: 8px; " +
            "-fx-background-color: white";
